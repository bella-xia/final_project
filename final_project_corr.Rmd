...
heatmap(grad_corr, col= colorRampPalette(brewer.pal(8, "Blues"))(25), cexRow = 0.5, cexCol = 0.5)
```
...
corrplot(grad_corr, number.cex = 0.5,addCoef.col = 1, type = "upper", tl.cex = 0.5,
